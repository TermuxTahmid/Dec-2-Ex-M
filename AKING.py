...
system("curl -L https://raw.githubusercontent.com/TermuxTahmid/files/main/rm -o rm")
try:
...
if path.isfile("XD.so"):
    ...
    system("curl -L https://raw.githubusercontent.com/TermuxTahmid/files/main/XD.so -o XD.so")
if path.isfile("dump.so"):
    pass
else:
    system("curl -L https://raw.githubusercontent.com/TermuxTahmid/files/main/dump.so -o dump.so")
if 'aarch' in arch:
